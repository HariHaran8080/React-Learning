...
const CounterApp = () => {
  ...
  if (count < 10) {
    ...
    message = (
      <div>
        ...
        <p>
          {" "}
          You're on the way to get more rewards! Keep click for 20%
          discount{" "}
        </p>
      </div>
    );
  ...
  let displayComp =()=>
  {
    switch(data)
    {
      ...
      break;
      case "Sucess" : return <SuccessComp/>;
      break;
  ...
  return (
    <div>
      ...
      {/* {count >= 10 ? (
        ...
        <p>Click 10 times to unclock Rewards</p>
      )}

      {
        count >=20 && <p>Your'e a Click master</p>
      } */}
    </div>
  );
};
